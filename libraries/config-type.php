...
$config['group'] = array(
    ...
    "Group Banner quảng cáo" => array(
        "photo_static" => array("banner"),
        "photo" => array("bannerqc"),
...
$config['seopage']['thumb'] = '380x200x2';
...
$config['setting']['phantrangdichvu'] = false;
...
//$config['lang']['active'] = false;



/* Quản lý comments */

//$config['comment']['active'] = true;
