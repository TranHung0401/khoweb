...
$wtm = $cache->get("select photo, options from #_photo where type = ? and act = ? and find_in_set('hienthi',status) limit 0,1", array('watermark', 'photo_static'), 'fetch', 7200);
...
$requick = array(
	...
	array("tbl" => "product_list", "field" => "idl", "source" => "product", "com" => "acquy", "type" => "acquy"),
	array("tbl" => "product", "field" => "id", "source" => "product", "com" => "acquy", "type" => "acquy", "menu" => true),

	array("tbl" => "product_list", "field" => "idl", "source" => "product", "com" => "phu-tung", "type" => "phu-tung"),
	array("tbl" => "product", "field" => "id", "source" => "product", "com" => "phu-tung", "type" => "phu-tung", "menu" => true),
	...
	array("tbl" => "news", "field" => "id", "source" => "news", "com" => "thong-tin-huu-ich", "type" => "thong-tin-huu-ich", "menu" => false),
	array("tbl" => "news", "field" => "id", "source" => "news", "com" => "kinh-nghiem", "type" => "kinh-nghiem", "menu" => false),
