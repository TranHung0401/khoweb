...
$config['product'][$nametype]['iframevd'] = true;
...
$config['product'][$nametype]['thongtinss'] = true;
$config['product'][$nametype]['thongtinss_cke'] = true;
$config['product'][$nametype]['thongtin'] = true;
$config['product'][$nametype]['thongtin_cke'] = true;
$config['product'][$nametype]['seo'] = true;
$config['product'][$nametype]['width'] = 840;
$config['product'][$nametype]['height'] = 540;
// $config['product'][$nametype]['width2'] = 270;
// $config['product'][$nametype]['height2'] = 270;
$config['product'][$nametype]['thumb'] = '210x135x2';
...
$config['product'][$nametype]['width_list'] = 227;
$config['product'][$nametype]['height_list'] = 227;
$config['product'][$nametype]['thumb_list'] = '227x227x1';
...
/* Ắc quy */
$nametype = "acquy";
$config['product'][$nametype]['title_main'] = "Ắc quy";
$config['product'][$nametype]['dropdown'] = true;
$config['product'][$nametype]['list'] = true;
...
/* Phụ tùng */
$nametype = "phu-tung";
$config['product'][$nametype]['title_main'] = "Phụ tùng";
$config['product'][$nametype]['dropdown'] = true;
$config['product'][$nametype]['list'] = true;
$config['product'][$nametype]['cat'] = false;
$config['product'][$nametype]['item'] = false;
