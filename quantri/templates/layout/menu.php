...
<aside class="main-sidebar sidebar-dark-primary elevation-4 text-sm">
    ...
    <a class="brand-link" href="index.php">
        <img class="brand-image" src="assets/images/logoadmin.png" style="max-width: 100%;" alt="Clickweb">
    </a>
    ...
    <div class="sidebar">
        <nav class="mt-3">
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent text-sm" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <!-- Quản lý ngôn ngữ -->
                <?php if(isset($config['lang']['active']) && $config['lang']['active'] == true) { ?>
                    <?php
                        $none = "";
                        $active = "";
                        if(isset($is_permission) && $is_permission == true) if($func->checkPermission('lang', 'man', '', null, 'phrase-1')) $none = "d-none";
                        if($com=='lang') $active = 'active';
                    ?>
                    <li class="nav-item <?=$active?> <?=$none?>">
                        <a class="nav-link <?=$active?>" href="index.php?com=lang&act=man" title="Quản lý ngôn ngữ">
                            <i class="nav-icon text-sm fas fa-shopping-bag"></i>
                ...
                <!-- Quản lý comments -->
                <?php if(isset($config['comment']['active']) && $config['comment']['active'] == true) { ?>
                    <?php
                        $none = "";
                        $active = "";
                        if(isset($is_permission) && $is_permission == true) if($func->checkPermission('comment', 'man', '', null, 'phrase-1')) $none = "d-none";
                        if($com=='comment') $active = 'active';
                    ?>
                    <li class="nav-item <?=$active?> <?=$none?>">
                        <a class="nav-link <?=$active?>" href="index.php?com=comment&act=man" title="Quản lý comments">
                            <i class="nav-icon text-sm fas fa-shopping-bag"></i>
