                                    ...
                                    <?php foreach ($config['website']['lang'] as $k => $v) { ?>
                                        <div class="tab-pane fade show <?= ($k == 'vi') ? 'active' : '' ?>" id="tabs-lang-<?= $k ?>" role="tabpanel" aria-labelledby="tabs-lang">
                                            ...
                                            <?php if (isset($config['news'][$type]['link']) && $config['news'][$type]['link'] == true) { ?>
                                                <div class="form-group">
                                                    <label for="link<?= $k ?>">Link (<?= $k ?>):</label>
                                                    <input type="text" class="form-control for-seo text-sm" name="data[link<?= $k ?>]" id="link<?= $k ?>" placeholder="Link (<?= $k ?>)" value="<?= (!empty($flash->has('link' . $k))) ? $flash->get('link' . $k) : @$item['link' . $k] ?>" required>
                                                </div>
                                            <?php } ?>
                                            <?php if (isset($config['news'][$type]['phone']) && $config['news'][$type]['phone'] == true) { ?>
                                                <div class="form-group">
                                                    <label for="phone<?= $k ?>">Điện thoại tư vấn (<?= $k ?>):</label>
                                                    <input type="number" class="form-control for-seo text-sm" name="data[phone<?= $k ?>]" id="phone<?= $k ?>" placeholder="Số điện thoại (<?= $k ?>)" value="<?= (!empty($flash->has('phone' . $k))) ? $flash->get('phone' . $k) : @$item['phone' . $k] ?>" required>
                                                </div>
                                            <?php } ?>
                                            ...
                                            <?php } ?>
                                            <?php if (isset($config['news'][$type]['toado_iframe']) && $config['news'][$type]['toado_iframe'] == true) { ?>
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control text-sm" name="data[toado_iframe]" id="toado_iframe" rows="5" placeholder="Tọa độ google map iframe"><?= htmlspecialchars_decode((!empty($flash->has('toado_iframe'))) ? $flash->get('toado_iframe') : @$item['toado_iframe']) ?></textarea>
                                                </div>
                                            <?php } ?>
                                        </div>
                                    <?php } ?>
