                            ...
                            <div class="card-body card-article">
                                <div class="tab-content" id="custom-tabs-three-tabContent-lang">
                                    ...
                                    <div class="tab-pane fade show <?= ($k == 'vi') ? 'active' : '' ?>"
                                        ...
                                        <?php if (isset($config['product'][$type]['thongtin']) && $config['product'][$type]['thongtin'] == true) { ?>
                                        <div class="form-group">
                                            <label for="content<?= $k ?>">Thông tin số kĩ thuật (<?= $k ?>):</label>
                                            <textarea
                                                class="form-control for-seo text-sm <?= (isset($config['product'][$type]['thongtin_cke']) && $config['product'][$type]['thongtin_cke'] == true) ? 'form-control-ckeditor' : '' ?>"
                                                name="data[thongtin<?= $k ?>]" id="thongtin<?= $k ?>" rows="5"
                                                placeholder="Nội dung (<?= $k ?>)"><?= htmlspecialchars_decode((!empty($flash->has('thongtin' . $k))) ? $flash->get('thongtin' . $k) : @$item['thongtin' . $k]) ?></textarea>
                                        </div>
                                        <?php } ?>
                                        <?php if (isset($config['product'][$type]['thongtinss']) && $config['product'][$type]['thongtinss'] == true) { ?>
                                        <div class="form-group">
                                            <label for="content<?= $k ?>">Thông tin chung (<?= $k ?>):</label>
                                            <textarea
                                                class="form-control for-seo text-sm <?= (isset($config['product'][$type]['thongtinss_cke']) && $config['product'][$type]['thongtinss_cke'] == true) ? 'form-control-ckeditor' : '' ?>"
                                                name="data[thongtinss<?= $k ?>]" id="thongtinss<?= $k ?>" rows="5"
                                                placeholder="Nội dung (<?= $k ?>)"><?= htmlspecialchars_decode((!empty($flash->has('thongtinss' . $k))) ? $flash->get('thongtinss' . $k) : @$item['thongtinss' . $k]) ?></textarea>
                                        </div>
                                        <?php } ?>

                                        <?php if (isset($config['product'][$type]['iframevd']) && $config['product'][$type]['iframevd'] == true) { ?>
                                        <div class="form-group">
                                            <label for="iframevd<?= $k ?>">Iframe video (<?= $k ?>):</label>
                                            <textarea
                                                class="form-control for-seo text-sm"
                                                name="data[iframevd<?= $k ?>]" id="iframevd<?= $k ?>" rows="5"
                                                placeholder="Iframe video (<?= $k ?>)"><?= htmlspecialchars_decode((!empty($flash->has('iframevd' . $k))) ? $flash->get('iframevd' . $k) : @$item['iframevd' . $k]) ?></textarea>
                                        </div>
                                        <?php } ?>
                                    </div>
                                    <?php } ?>
        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        <label class="d-block" for="regular_price">Giá cũ:</label>
