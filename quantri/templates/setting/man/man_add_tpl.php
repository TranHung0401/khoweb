            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4 col-sm-6">
                        ...
                        <input type="text" class="form-control text-sm" name="data[options][hotline2]" id="hotline2"
                            placeholder="Hotline2"
                            value="<?= (!empty($flash->has('hotline2'))) ? $flash->get('hotline2') : @$options['hotline2'] ?>"
                            required>
                    </div>
                    <?php } ?>

                    <?php if (isset($config['setting']['phantrangdichvu']) && $config['setting']['phantrangdichvu'] == true) { ?>
                    <div class="form-group col-md-4 col-sm-6">
                        <label for="phantrangdichvu">Phân trang dịch vụ</label>
                        <input type="text" class="form-control text-sm" name="data[options][phantrangdichvu]" id="phantrangdichvu"
                            placeholder="Phân trang dịch vụ"
                            value="<?= (!empty($flash->has('phantrangdichvu'))) ? $flash->get('phantrangdichvu') : @$options['phantrangdichvu'] ?>"
                            required>
                    </div>
                    <?php } ?>
