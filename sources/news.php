<?php  
	...
	if($id!='')
	{
		...
		$tinlienquan = $d->rawQuery("select id, view, date_created, id_list, id_cat, id_item, id_sub, type, name$lang, slugvi, slugen, desc$lang, content$lang, photo, options from #_news where id <> ? and type = ? and find_in_set('hienthi',status)",array($id,'kinh-nghiem'));
